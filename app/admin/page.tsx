...
export default function AdminDashboard() {
  ...
  const statusColors: any = {
    'pending': 'bg-[#fdf9ec] text-[#C8952A]',
    'processing': 'bg-[#fdf9ec] text-[#C8952A]',
    'shipped': 'bg-[#fdf9ec] text-[#C8952A]',
    'delivered': 'bg-[#fdf9ec] text-[#C8952A]',
    'cancelled': 'bg-[#fdf9ec] text-[#C8952A]'
  };
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-8">
          <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            <div className="flex items-center justify-between mb-4">
              ...
              <select
                className="bg-gray-50 border border-gray-200 text-gray-700 text-sm rounded-lg focus:ring-[#C8952A] focus:border-[#C8952A] block p-2"
                value={dateRange}
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="space-y-3">
              <Link href="/admin/products/new" className="flex items-center justify-between p-4 bg-gray-50 hover:bg-[#fdf9ec] text-gray-700 hover:text-[#C8952A] rounded-lg transition-colors group">
                <div className="flex items-center font-medium">
                  <span className="w-8 h-8 rounded-full bg-white flex items-center justify-center mr-3 group-hover:bg-[#fdf9ec] transition-colors shadow-sm">
              ...
              <Link href="/admin/pos" className="flex items-center justify-between p-4 bg-gray-50 hover:bg-[#fdf9ec] text-gray-700 hover:text-[#C8952A] rounded-lg transition-colors group">
                <div className="flex items-center font-medium">
                  <span className="w-8 h-8 rounded-full bg-white flex items-center justify-center mr-3 group-hover:bg-[#fdf9ec] transition-colors shadow-sm">
              ...
              <Link href="/admin/orders" className="flex items-center justify-between p-4 bg-gray-50 hover:bg-[#fdf9ec] text-gray-700 hover:text-[#C8952A] rounded-lg transition-colors group">
                <div className="flex items-center font-medium">
                  <span className="w-8 h-8 rounded-full bg-white flex items-center justify-center mr-3 group-hover:bg-[#fdf9ec] transition-colors shadow-sm">
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-8">
          <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 overflow-hidden">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="/admin/orders" className="text-[#C8952A] hover:text-[#a07020] font-medium text-sm whitespace-nowrap cursor-pointer">
                    ...
                    {recentOrders.map((order) => (
                      <tr key={order.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                        <td className="py-4 px-4">
                          <Link href={`/admin/orders/${order.id}`} className="text-[#C8952A] hover:text-[#a07020] font-medium whitespace-nowrap cursor-pointer">
                            {order.displayId}
                          </Link>
                        </td>
                        <td className="py-4 px-4">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <Link href="/admin/products?filter=low-stock" className="block text-center mt-4 text-[#C8952A] hover:text-[#a07020] font-medium text-sm whitespace-nowrap cursor-pointer">
            ...
            {topProducts.map((product) => (
              <div key={product.id} className="border border-gray-200 rounded-xl p-4 hover:shadow-md transition-shadow">
                ...
                <div className="mt-3 pt-3 border-t border-gray-200 flex items-center justify-between">
                  ...
                  <Link href={`/admin/products/${product.id}`} className="text-[#C8952A] hover:text-[#a07020] text-sm font-medium whitespace-nowrap cursor-pointer">
