    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
                ...
                {success && <div className="bg-[#fdf9ec] text-[#C8952A] p-4 rounded-lg mb-4">{success}</div>}
                {error && <div className="bg-[#fdf9ec] text-[#C8952A] p-4 rounded-lg mb-4">{error}</div>}
                ...
                <form onSubmit={handleSend} className="space-y-6">
                    <div>
                        ...
                        <select
                            ...
                            className="w-full p-3 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-[#C8952A]"
                        >
                    ...
                    <div className="flex gap-6 p-4 bg-gray-50 rounded-lg border border-gray-100">
                        <label className="flex items-center gap-2 cursor-pointer">
                            <input
                                ...
                                className="w-5 h-5 text-[#C8952A] rounded focus:ring-[#C8952A] cursor-pointer"
                            />
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full p-3 border border-gray-300 rounded-lg h-40 outline-none focus:ring-2 focus:ring-[#C8952A]"
                    ...
                    <button
                        ...
                        className="w-full bg-[#111111] text-white py-4 rounded-lg font-bold text-lg hover:bg-[#111111] transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                    >
                        {loading ? (
