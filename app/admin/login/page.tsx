      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-block">
            <Image src="/logo.png" alt="Maame K’s Kitchen" width={90} height={28} className="h-7 w-auto mx-auto object-contain" style={{ width: 'auto', height: 'auto' }} />
          </Link>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          {error && (
            <div className="mb-6 p-4 bg-[#fdf9ec] border border-[#e8c87a] rounded-lg flex items-start space-x-3">
              <i className="ri-error-warning-line text-[#C8952A] text-xl mt-0.5"></i>
              <div>
                <p className="text-[#a07020] font-semibold">Login Failed</p>
                <p className="text-[#C8952A] text-sm mt-1">{error}</p>
              </div>
            </div>
          )}
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#C8952A] focus:border-[#C8952A]"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#C8952A] focus:border-[#C8952A]"
            ...
            <button
              ...
              className="w-full bg-[#111111] hover:bg-[#111111] text-white py-3 rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
            >
              {isLoading || verifying ? (
        ...
        <div className="mt-6 text-center">
          <Link href="/" className="text-sm text-gray-600 hover:text-[#C8952A] transition-colors whitespace-nowrap">
