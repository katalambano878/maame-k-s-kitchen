...
export default function POSPage() {
    ...
    // Replace with the regions/states you ship to
    const ghanaRegions = [
        ...
        <div className="flex flex-col lg:flex-row h-[calc(100vh-90px)] -m-4 lg:-m-6 overflow-hidden bg-gray-100 relative">
                ...
                <div className="bg-white p-4 border-b border-gray-200 flex items-center justify-between space-x-4 shrink-0">
                    <div className="relative flex-1 max-w-lg">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#C8952A] text-sm"
                            autoFocus
                        />
                    </div>
                                ...
                                >
                                    ...
                                    <div className="p-3 flex flex-col flex-1">
                                        ...
                                        <div className="flex items-center justify-between mt-2 pt-2">
                                            <span className="text-[#C8952A] font-bold">${product.price.toFixed(2)}</span>
                                            <button className="w-8 h-8 rounded-full bg-[#fdf9ec] text-[#C8952A] flex items-center justify-center group-hover:bg-[#111111] group-hover:text-white transition-colors">
                ...
                {cart.length > 0 && (
                    <div className="lg:hidden p-4 border-t border-gray-200 bg-white fixed bottom-0 left-0 right-0 z-30 shadow-2xl safe-area-bottom">
                        <button
                            ...
                            className="w-full py-3 bg-[#111111] text-white rounded-xl font-bold flex justify-between px-6 shadow-lg active:scale-95 transition-transform"
                        >
            ...
            <div className={`w-full lg:w-96 bg-white border-l border-gray-200 flex flex-col h-full shadow-lg z-20 absolute inset-0 lg:relative ${isMobileCartOpen ? 'flex' : 'hidden lg:flex'}`}>
                <div className="p-4 border-b border-gray-200 flex items-center justify-between bg-gray-50 shrink-0">
                    ...
                    <span className="bg-[#fdf9ec] text-[#a07020] text-xs font-bold px-2 py-1 rounded-full">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-3">
                    {cart.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-full text-gray-400 space-y-4">
                            ...
                            <button onClick={() => setIsMobileCartOpen(false)} className="lg:hidden text-[#C8952A] font-medium hover:underline">
                            ...
                            <div key={item.id} className="flex gap-3 p-3 bg-gray-50 rounded-lg group hover:bg-gray-100 transition-colors">
                                ...
                                <div className="flex-1 min-w-0 flex flex-col justify-between">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <button onClick={() => removeFromCart(item.id)} className="text-gray-400 hover:text-[#C8952A]">
                                    ...
                                    <div className="flex items-center justify-between mt-2">
                                        ...
                                        <p className="text-sm font-bold text-gray-900">${(item.price * item.cartQuantity).toFixed(2)}</p>
                                    </div>
                                </div>
                            </div>
                        ))
                ...
                <div className="p-4 bg-gray-50 border-t border-gray-200 space-y-4 shrink-0 safe-area-bottom">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        <button
                            ...
                            className="px-4 py-3 border border-[#e8c87a] text-[#C8952A] rounded-lg hover:bg-[#fdf9ec] font-semibold text-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            Clear
                        </button>
                        <button
                            ...
                            disabled={cart.length === 0}
                            className="px-4 py-3 bg-[#111111] text-white rounded-lg hover:bg-[#111111] font-bold text-sm shadow-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                    ...
                    <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                        {completedOrder ? (
                            ...
                            <div className="p-8 text-center flex flex-col items-center justify-center space-y-6 overflow-y-auto">
                                <div className={`w-20 h-20 rounded-full flex items-center justify-center ${completedOrder.paymentPending ? 'bg-[#fdf9ec]' : 'bg-[#fdf9ec]'}`}>
                                    <i className={`text-5xl ${completedOrder.paymentPending ? 'ri-time-line text-[#C8952A]' : 'ri-checkbox-circle-fill text-[#C8952A]'}`}></i>
                                </div>
                                <div>
                                    ...
                                    {!completedOrder.paymentPending && paymentMethod === 'cash' && changeDue > 0 && (
                                        <div className="mt-3 bg-[#fdf9ec] border border-[#e8c87a] rounded-lg p-3">
                                            <p className="text-sm text-[#C8952A]">Change Due</p>
                                            <p className="text-2xl font-bold text-[#a07020]">${changeDue.toFixed(2)}</p>
                                        </div>
                                    )}
                                    ...
                                    {completedOrder.paymentPending && completedOrder.paymentUrl && (
                                        <div className="mt-4 space-y-3">
                                            ...
                                            <a
                                                ...
                                                className="inline-flex items-center px-6 py-3 bg-[#111111] text-white rounded-xl font-semibold hover:bg-[#111111] transition-colors"
                                            >
                                            ...
                                            <div className="mt-2">
                                                <button
                                                    ...
                                                    className="text-sm text-[#C8952A] hover:text-[#a07020] font-medium underline"
                                                >
                                ...
                                <div className="grid grid-cols-2 gap-4 w-full mt-4">
                                    ...
                                    <button onClick={resetCheckout} className="py-3 px-4 bg-[#111111] text-white rounded-xl font-semibold hover:bg-[#111111] transition-colors">
                                        New Order
                                    </button>
                                </div>
                            </div>
                            ...
                            <>
                                ...
                                <div className="p-6 space-y-6 overflow-y-auto">
                                    {/* Error Display */}
                                    {checkoutError && (
                                        <div className="bg-[#fdf9ec] border border-[#e8c87a] rounded-lg p-3 flex items-start space-x-2">
                                            <i className="ri-error-warning-line text-[#C8952A] mt-0.5"></i>
                                            <p className="text-sm text-[#C8952A]">{checkoutError}</p>
                                        </div>
                                    )}

                                    {/* Total Display */}
                                    <div className="text-center py-4 bg-[#fdf9ec] rounded-xl border border-[#f5de8f]">
                                        <p className="text-sm text-[#a07020] uppercase tracking-wide font-semibold">Amount to Pay</p>
                                        <p className="text-4xl font-extrabold text-[#C8952A] mt-1">${grandTotal.toFixed(2)}</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative mb-2">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-9 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#C8952A] outline-none text-sm"
                                            />
                                        </div>

                                        <select
                                            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#C8952A] outline-none mb-2"
                                            onChange={(e) => {
                                        ...
                                        {selectedCustomer && (
                                            <div className="bg-[#fdf9ec] border border-[#e8c87a] rounded-lg p-3 mb-2 flex items-center justify-between">
                                                <div>
                                                ...
                                                <button
                                                    ...
                                                    className="text-gray-400 hover:text-[#C8952A] text-sm"
                                                >
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            ...
                                            >
                                                <i className={`ri-store-2-line text-xl ${deliveryMethod === 'pickup' ? 'text-[#C8952A]' : 'text-gray-400'}`}></i>
                                                <div className="text-left">
                                                    <p className={`text-sm font-semibold ${deliveryMethod === 'pickup' ? 'text-[#a07020]' : 'text-gray-700'}`}>Store Pickup</p>
                                            ...
                                            >
                                                <i className={`ri-truck-line text-xl ${deliveryMethod === 'doorstep' ? 'text-[#C8952A]' : 'text-gray-400'}`}></i>
                                                <div className="text-left">
                                                    <p className={`text-sm font-semibold ${deliveryMethod === 'doorstep' ? 'text-[#a07020]' : 'text-gray-700'}`}>Doorstep Delivery</p>
                                        ...
                                        {deliveryMethod === 'doorstep' && (
                                            <div className="mt-3 bg-[#fdf9ec] p-4 rounded-lg border border-[#e8c87a] space-y-3">
                                                <h4 className="text-sm font-bold text-gray-900 flex items-center">
                                                    <i className="ri-map-pin-line mr-2 text-[#C8952A]"></i>
                                                    Delivery Address
                                                </h4>
                                                <input
                                                    type="text"
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#C8952A] outline-none font-bold text-lg"
                                                    placeholder="0.00"
                                                    autoFocus
                                                />
                                            </div>
                                            {changeDue > 0 && (
                                                <p className="text-right text-[#C8952A] font-bold mt-2">Change: ${changeDue.toFixed(2)}</p>
                                            )}
                                            {changeDue < 0 && amountTendered && (
                                                <p className="text-right text-[#C8952A] font-medium mt-2">Insufficient amount</p>
                                            )}
                                    ...
                                    {paymentMethod === 'card' && (
                                        <div className="bg-[#fdf9ec] border border-[#e8c87a] rounded-lg p-3">
                                            <div className="flex items-start space-x-2">
                                                <i className="ri-bank-card-line text-[#C8952A] mt-0.5"></i>
                                                <div className="text-sm text-[#a07020]">
                                ...
                                <div className="p-6 border-t border-gray-100 bg-gray-50 shrink-0">
                                    <button
                                        ...
                                        disabled={processing}
                                        className="w-full py-4 bg-[#111111] text-white rounded-xl font-bold text-lg shadow-lg hover:bg-[#111111] disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center space-x-2"
                                    >
                                        {processing ? (
                                            <>
