      ...
      >
        <div className="h-full px-4 py-6 overflow-y-auto">
          <Link href="/admin" className="flex flex-col items-start gap-1 mb-8 px-2 cursor-pointer">
            <Image src="/logo.png" alt="Mama K" width={160} height={48} className="h-10 w-auto object-contain" />
              ...
              return (
                <Link
                  ...
                  className={`flex items-center justify-between px-4 py-3 rounded-lg transition-colors cursor-pointer ${isActive
                    ? 'bg-[#fdf9ec] text-[#C8952A] font-semibold'
                ...
                >
                  ...
                  {item.badge && (
                    <span className="bg-[#fdf9ec] text-[#C8952A] text-xs font-bold px-2 py-1 rounded-full">
                      {item.badge}
                    </span>
                  )}
                </Link>
          ...
          <div className="px-4 py-4 lg:px-6 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 lg:space-x-4">
              <button className="relative w-10 h-10 flex items-center justify-center text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors cursor-pointer">
                ...
                <span className="absolute top-1 right-1 w-2 h-2 bg-[#C8952A] rounded-full"></span>
              </button>
              ...
              <div className="relative user-menu-container">
                ...
                >
                  <div className="w-8 h-8 lg:w-9 lg:h-9 flex items-center justify-center bg-[#fdf9ec] text-[#C8952A] rounded-full font-semibold">
                ...
                {showUserMenu && (
                  <div className="absolute right-0 mt-2 w-56 bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden z-20">
                    ...
                    >
                      <i className="ri-logout-box-line text-[#C8952A] w-5 h-5 flex items-center justify-center"></i>
                      <span className="text-[#C8952A]">Logout</span>
                    </button>
                  </div>
                )}
              </div>
