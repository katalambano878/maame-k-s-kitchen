                ...
                <div className="bg-white p-6 rounded-lg shadow border border-gray-100">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                type="text"
                                className="w-full border rounded-md p-2 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-[#C8952A] outline-none"
                                placeholder="e.g. local format or +1..."
                                value={phone}
                                onChange={(e) => setPhone(e.target.value)}
                            />
                            <p className="text-xs text-gray-500 mt-1">
                                Try a local format to test auto-formatting to E.164.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                className="w-full border rounded-md p-2 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-[#C8952A] outline-none h-24"
