      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 flex items-center justify-center bg-[#fdf9ec] rounded-lg">
                <i className="ri-stack-line text-2xl text-[#C8952A]"></i>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-[#C8952A]">{lowStockCount}</p>
              </div>
              <div className="w-12 h-12 flex items-center justify-center bg-[#fdf9ec] rounded-lg">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-[#C8952A]">{outOfStockCount}</p>
              </div>
              <div className="w-12 h-12 flex items-center justify-center bg-[#fdf9ec] rounded-lg">
                <i className="ri-close-circle-line text-2xl text-[#C8952A]"></i>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 flex items-center justify-center bg-[#fdf9ec] rounded-lg">
                <i className="ri-money-dollar-circle-line text-2xl text-[#C8952A]"></i>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="bg-[#111111] hover:bg-[#111111] text-white px-4 py-3 rounded-lg font-semibold transition-colors flex items-center space-x-2 whitespace-nowrap cursor-pointer"
              >
          ...
          {selectedProducts.length > 0 && (
            <div className="mt-4 flex items-center justify-between p-4 bg-[#fdf9ec] border border-[#e8c87a] rounded-lg">
              <p className="text-[#a07020] font-medium">
                ...
                <tr>
                  <th className="px-6 py-4 text-left">
                    <input
                      ...
                      className="w-5 h-5 text-[#C8952A] rounded cursor-pointer"
                    />
                  </th>
                ...
                {loading ? (
                  ...
                  filteredProducts.map((product) => (
                    <tr key={product.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        {product.status === 'good' && (
                          <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-[#fdf9ec] text-[#C8952A] whitespace-nowrap">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center space-x-2">
                          <button
                            className="w-8 h-8 flex items-center justify-center text-gray-600 hover:text-[#C8952A] transition-colors cursor-pointer"
                            title="Edit"
                          >
