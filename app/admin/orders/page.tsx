...
export default function AdminOrdersPage() {
  ...
  const statusColors: Record<string, string> = {
    ...
    'shipped': 'bg-[#fdf9ec] text-[#C8952A] border-[#e8c87a]',
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          <button
            ...
            className="flex-1 md:flex-none bg-[#111111] hover:bg-[#111111] text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap cursor-pointer shadow-sm flex items-center justify-center"
          >
      ...
      {orderViewTab === 'abandoned' && abandonedCount > 0 && (
        <div className="bg-[#fdf9ec] border border-[#e8c87a] rounded-lg p-4">
          <div className="flex items-start space-x-3">
            <i className="ri-information-line text-xl text-[#C8952A] mt-0.5"></i>
            <div>
              <p className="text-sm font-semibold text-[#a07020]">Abandoned Carts</p>
              ...
              {loading ? (
                <tr>
                  <td colSpan={9} className="py-12 text-center text-gray-500">
                    <i className="ri-loader-4-line animate-spin text-3xl text-[#C8952A]"></i>
                ...
                filteredOrders.map((order) => (
                  <tr key={order.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-4 px-4">
                      <Link href={`/admin/orders/${order.id}`} className="text-[#C8952A] hover:text-[#a07020] font-semibold whitespace-nowrap cursor-pointer">
                    ...
                    <td className="py-4 px-4 text-sm whitespace-nowrap">
                      <div className="flex flex-col">
                        ...
                        {orderViewTab === 'abandoned' && (
                          <span className={`text-xs mt-1 ${order.payment_status === 'failed' ? 'text-[#C8952A]' : 'text-[#C8952A]'}`}>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        {orderViewTab === 'abandoned' && order.payment_status !== 'paid' && (
                          <button
                            ...
                            className="w-8 h-8 flex items-center justify-center text-[#C8952A] hover:text-[#a07020] hover:bg-[#fdf9ec] rounded-lg transition-colors cursor-pointer disabled:opacity-50"
