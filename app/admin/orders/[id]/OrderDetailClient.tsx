...
export default function OrderDetailClient({ orderId }: OrderDetailClientProps) {
  ...
  const statusLabel = (s: string) => s === 'out_for_delivery' ? 'Packaged' : s.charAt(0).toUpperCase() + s.slice(1);
  const statusColors: any = {
    'pending': 'bg-[#fdf9ec] text-[#C8952A] border-[#e8c87a]',
    'processing': 'bg-[#fdf9ec] text-[#C8952A] border-[#e8c87a]',
    'out_for_delivery': 'bg-[#fdf9ec] text-[#C8952A] border-[#e8c87a]',
    'delivered': 'bg-[#fdf9ec] text-[#C8952A] border-[#e8c87a]',
    'cancelled': 'bg-[#fdf9ec] text-[#C8952A] border-[#e8c87a]',
    'awaiting_payment': 'bg-gray-100 text-gray-700 border-gray-200'
  };

  if (loading) return <div className="p-8 text-center">Loading...</div>;
  if (error || !order) return <div className="p-8 text-center text-[#C8952A]">{error || 'Order not found'}</div>;
  ...
  const timeline = [
    ...
    { status: 'Processing', date: '', completed: ['processing', 'out_for_delivery', 'delivered'].includes(order.status) },
    { status: 'Packaged', date: '', completed: ['out_for_delivery', 'delivered'].includes(order.status) },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="print-section hidden print:block bg-white p-8">
        <div className="border-2 border-gray-800 p-6">
          ...
          <div className="flex justify-between items-start border-b-2 border-gray-800 pb-4 mb-4">
            <div>
              <h1 className="text-2xl font-bold">Maame K’s Kitchen</h1>
      ...
      <div className="max-w-7xl mx-auto p-6 no-print">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            onClick={handlePrint}
            className="flex items-center space-x-2 bg-[#111111] hover:bg-[#111111] text-white px-4 py-2 rounded-lg font-medium transition-colors"
          >
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 space-y-3">
                ...
                {order.discount_total > 0 && (
                  <div className="flex justify-between text-[#C8952A] font-semibold">
                    <span>Discount</span>
              ...
              <div className="space-y-4">
                {timeline.map((event, index) => (
                  <div key={index} className="flex items-start space-x-4">
                    <div className={`w-10 h-10 flex items-center justify-center rounded-full border-2 ${event.completed ? 'bg-[#111111] border-[#C8952A]' : 'bg-white border-gray-300'
                      }`}>
                      {event.completed ? (
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                  ...
                  <div className="absolute top-full left-0 right-0 mt-2 bg-white border-2 border-gray-200 rounded-lg shadow-lg overflow-hidden z-10">
                    {statusOptions.map((status) => (
                      <button
                        ...
                        className={`w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors ${status === currentStatus ? 'bg-[#fdf9ec] font-semibold' : ''
                          }`}
                      >
                        {statusLabel(status)}
                      </button>
              ...
              <button
                ...
                className="w-full mt-4 bg-[#111111] hover:bg-[#111111] text-white py-3 rounded-lg font-semibold transition-colors whitespace-nowrap disabled:opacity-50"
              >
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="flex items-start space-x-3 mb-4">
                <div className="w-12 h-12 flex items-center justify-center bg-[#fdf9ec] text-[#C8952A] rounded-full font-semibold uppercase">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="px-3 py-1 bg-[#fdf9ec] text-[#C8952A] rounded-full text-sm font-semibold whitespace-nowrap capitalize">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <button
                ...
                className="w-full bg-[#111111] hover:bg-[#111111] text-white py-3 rounded-lg font-semibold transition-colors whitespace-nowrap disabled:opacity-50 flex items-center justify-center"
              >
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <button
                onClick={() => handleUpdateStatus()}
                disabled={statusUpdating}
                className="w-full mt-3 bg-[#111111] hover:bg-[#111111] text-white py-2 rounded-lg font-medium transition-colors whitespace-nowrap disabled:opacity-50"
              >
                Save Note
              </button>
            </div>
