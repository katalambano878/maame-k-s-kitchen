        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm">
              ...
              <span className="font-medium text-[#C8952A]">{phone}</span>
            </p>
          </div>
          ...
          <div className="space-y-6">
              ...
              <div className="flex gap-2 justify-center" onPaste={handlePaste}>
                {code.map((digit, index) => (
                  <input
                    ...
                    className="w-12 h-14 text-center text-2xl font-bold border-2 rounded-lg focus:border-[#C8952A] focus:ring-2 focus:ring-[#C8952A]/20 transition-all"
                  />
                ))}
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-3 bg-[#111111] text-white rounded-lg hover:bg-[#111111] transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed font-medium whitespace-nowrap"
            >
              {isVerifying ? (
                <>
          ...
          <div className="mt-8 pt-6 border-t">
            <div className="bg-[#fdf9ec] rounded-lg p-4">
              <h3 className="font-semibold text-sm mb-2 flex items-center gap-2">
                <i className="ri-shield-check-line text-[#C8952A]"></i>
          ...
          <div className="mt-6">
            <div className="bg-[#fdf9ec] border border-[#e8c87a] rounded-lg p-3">
              <p className="text-xs text-[#7a5418]">
