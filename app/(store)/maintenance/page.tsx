export default function MaintenancePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-[#0d0d0d] flex items-center justify-center px-4">
      <div className="max-w-2xl mx-auto text-center">
        <div className="mb-8">
          <div className="w-32 h-32 bg-[#fdf9ec] rounded-full flex items-center justify-center mx-auto mb-6">
            <i className="ri-tools-line text-6xl text-[#C8952A]"></i>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8">
          ...
          <div className="flex items-center justify-center gap-3 text-[#C8952A]">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <div className="w-12 h-12 bg-[#fdf9ec] rounded-full flex items-center justify-center mx-auto mb-4">
              <i className="ri-rocket-line text-2xl text-[#C8952A]"></i>
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <div className="w-12 h-12 bg-[#fdf9ec] rounded-full flex items-center justify-center mx-auto mb-4">
              <i className="ri-sparkle-line text-2xl text-[#C8952A]"></i>
            </div>
        ...
        <div className="bg-[#fdf9ec] border border-[#e8c87a] rounded-2xl p-8 mb-8">
        ...
        <div className="text-gray-500 text-sm">
          ...
          <div className="flex gap-4 justify-center mt-4">
            <a href="https://example.com/social" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white border border-gray-200 rounded-full flex items-center justify-center hover:bg-gray-50 transition-colors">
