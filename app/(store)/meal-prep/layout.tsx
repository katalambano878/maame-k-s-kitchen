...
export const metadata: Metadata = {
  ...
  description:
    "Subscribe to Maame K's Kitchen weekly meal prep in Cornerstone, NE Calgary. Choose your meals each week — cancel anytime with 3 days notice before delivery.",
  openGraph: {
