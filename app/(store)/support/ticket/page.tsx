            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-3">
                ...
                <Link
                  ...
                  className="block bg-[#111111] hover:bg-[#111111] text-white py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
                >
                  View My Tickets
                </Link>
                <Link
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4">
          <Link
            href="/help"
            className="inline-flex items-center text-[#C8952A] hover:text-[#7a5418] font-semibold mb-6 whitespace-nowrap"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <i className={`${cat.icon} text-2xl ${
                          formData.category === cat.value ? 'text-[#C8952A]' : 'text-gray-400'
                        }`}></i>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  ...
                  <label className={`flex-1 p-4 rounded-lg border-2 cursor-pointer transition-all ${
                    formData.priority === 'normal' ? 'border-[#C8952A] bg-[#fdf9ec]' : 'border-gray-300'
                  }`}>
                    <input
                      type="radio"
                      value="normal"
                  ...
                  <label className={`flex-1 p-4 rounded-lg border-2 cursor-pointer transition-all ${
                    formData.priority === 'high' ? 'border-[#C8952A] bg-[#fdf9ec]' : 'border-gray-300'
                  }`}>
                    <input
                      type="radio"
                      value="high"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#C8952A] focus:border-[#C8952A] h-32 resize-none"
          ...
          <div className="mt-8 bg-[#fdf9ec] border border-[#e8c87a] rounded-xl p-6">
            <div className="flex items-start space-x-3">
              <i className="ri-information-line text-2xl text-[#C8952A] mt-0.5"></i>
              <div>
                <p className="font-semibold text-[#7a5418] mb-2">Before submitting a ticket</p>
                <ul className="text-sm text-[#C8952A] space-y-1">
                  <li>• Check our <Link href="/help" className="underline hover:text-[#7a5418]">Help Center</Link> for quick answers</li>
