  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-[#C8952A] hover:text-[#a07020] mb-6 whitespace-nowrap"
        >
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
              ...
              <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
                isInstalled ? 'bg-[#fdf9ec] text-[#C8952A]' : 'bg-gray-200 text-gray-500'
              }`}>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
              <div className="w-10 h-10 bg-[#fdf9ec] rounded-full flex items-center justify-center">
                <i className="ri-notification-line text-[#C8952A]"></i>
              </div>
              Notifications
            </h2>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                ...
                {notificationPermission === 'default' && (
                  <button
                    ...
                    className="px-4 py-2 bg-[#111111] text-white rounded-lg hover:bg-[#111111] transition-colors whitespace-nowrap"
                  >
                    Enable
                  </button>
                )}
                {notificationPermission === 'granted' && (
                  <div className="w-12 h-12 bg-[#fdf9ec] rounded-full flex items-center justify-center">
                    <i className="ri-check-line text-[#C8952A] text-2xl"></i>
                  </div>
                )}
                {notificationPermission === 'denied' && (
                  <div className="w-12 h-12 bg-[#fdf9ec] rounded-full flex items-center justify-center">
                    <i className="ri-close-line text-[#C8952A] text-2xl"></i>
                  </div>
                )}
              </div>

              {notificationPermission === 'granted' && (
                <div className="bg-[#fdf9ec] border border-[#e8c87a] rounded-xl p-4">
                  <p className="text-sm text-[#a07020] font-medium mb-2">You will receive notifications for:</p>
                  <ul className="space-y-1 text-sm text-[#C8952A]">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
              <div className="w-10 h-10 bg-[#fdf9ec] rounded-full flex items-center justify-center">
                <i className="ri-database-line text-[#C8952A]"></i>
              </div>
              Storage & Cache
            </h2>
            <div className="space-y-4">
              ...
              <div className="bg-[#fdf9ec] border border-[#e8c87a] rounded-xl p-4">
                <div className="flex items-start gap-3">
                  <i className="ri-information-line text-[#C8952A] text-xl"></i>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
              <div className="w-10 h-10 bg-[#fdf9ec] rounded-full flex items-center justify-center">
                <i className="ri-flashlight-line text-[#C8952A]"></i>
              </div>
              PWA Features
            </h2>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 bg-[#fdf9ec] rounded-xl">
                <div className="flex items-center gap-3 mb-2">
                  <i className="ri-wifi-off-line text-[#C8952A] text-xl"></i>
                  <span className="font-semibold text-gray-900">Offline Mode</span>
                </div>
                <p className="text-sm text-gray-700">Browse cached pages without internet</p>
              </div>
              <div className="p-4 bg-[#fdf9ec] rounded-xl">
                <div className="flex items-center gap-3 mb-2">
                  <i className="ri-rocket-line text-[#C8952A] text-xl"></i>
                  <span className="font-semibold text-[#7a5418]">Fast Loading</span>
                </div>
                <p className="text-sm text-[#a07020]">Instant page loads with smart caching</p>
              </div>
              <div className="p-4 bg-[#fdf9ec] rounded-xl">
                <div className="flex items-center gap-3 mb-2">
                  <i className="ri-home-line text-[#C8952A] text-xl"></i>
                  <span className="font-semibold text-[#7a5418]">Home Screen</span>
                </div>
                <p className="text-sm text-[#a07020]">Add to home screen like a native app</p>
              </div>
              <div className="p-4 bg-[#fdf9ec] rounded-xl">
                <div className="flex items-center gap-3 mb-2">
                  <i className="ri-refresh-line text-[#C8952A] text-xl"></i>
                  <span className="font-semibold text-[#7a5418]">Auto Updates</span>
                </div>
                <p className="text-sm text-[#a07020]">Automatic updates in the background</p>
              </div>
            </div>
          </div>
        </div>
