          ...
          <div className="bg-white rounded-xl shadow-sm p-8 mb-6">
            <div className="mb-6 pb-6 border-b border-gray-200">
              <div className="flex items-center space-x-3 mb-4">
                <span className="px-3 py-1 bg-[#fdf9ec] text-[#C8952A] rounded-full text-sm font-semibold whitespace-nowrap">
                  {article.category}
                </span>
            ...
            {!showFeedback ? (
              <div className="flex space-x-4">
                <button
                  ...
                  className="flex-1 py-3 px-6 border-2 border-[#C8952A] text-[#C8952A] hover:bg-[#111111] hover:text-white rounded-lg font-semibold transition-colors whitespace-nowrap"
                >
              ...
              <div className="text-center">
                {wasHelpful ? (
                  ...
                  <>
                    <div className="w-16 h-16 flex items-center justify-center bg-[#fdf9ec] rounded-full mx-auto mb-4">
                      <i className="ri-customer-service-line text-3xl text-[#C8952A]"></i>
                    </div>
                    <p className="text-lg font-semibold text-gray-900 mb-2">
              ...
              {relatedArticles.map((related) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    <i className="ri-file-text-line text-xl text-[#C8952A]"></i>
                    <div>
