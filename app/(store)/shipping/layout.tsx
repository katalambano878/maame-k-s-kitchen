...
export const metadata: Metadata = {
  ...
  description: "Maame Ks Kitchen delivery and pickup information — same-day delivery within Calgary, scheduled delivery to neighbouring areas, and free pickup from Cornerstone, NE Calgary, Alberta.",
  keywords: [
    "Maame Ks Kitchen delivery",
  ...
  openGraph: {
    title: 'Delivery & Pickup | Maame Ks Kitchen',
