...
export default function CookieConsent() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t-4 border-[#C8952A] shadow-2xl z-[9999] animate-slide-up">
        <div className="max-w-7xl mx-auto px-4 py-6">
          {!showPreferences ? (
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div className="flex items-start space-x-4 flex-1">
                <div className="w-12 h-12 flex items-center justify-center bg-[#fdf9ec] rounded-lg flex-shrink-0">
                  <i className="ri-cookie-line text-2xl text-[#C8952A]"></i>
                </div>
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed mb-3">
                    ...
                    <Link href="/privacy" className="text-[#C8952A] hover:text-[#7a5418] font-medium ml-1 whitespace-nowrap">
                  ...
                  <label className="flex items-start space-x-2 cursor-pointer group">
                    <input
                      ...
                      className="w-4 h-4 mt-0.5 text-[#C8952A] border-gray-300 rounded focus:ring-[#C8952A] cursor-pointer"
                    />
                    <span className="text-xs text-gray-600 group-hover:text-gray-900">
                      I agree to the{' '}
                      <Link href="/terms" className="text-[#C8952A] hover:text-[#7a5418] font-medium">
                        Terms & Conditions
                      </Link>
                      {' '}and{' '}
                      <Link href="/privacy" className="text-[#C8952A] hover:text-[#7a5418] font-medium">
                        Privacy Policy
                      </Link>
                    </span>
                  </label>
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap ${
                    acceptedTerms
                      ? 'bg-[#111111] hover:bg-[#111111] text-white cursor-pointer'
            ...
            <div>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors cursor-pointer ${
                      preferences.analytics ? 'bg-[#111111]' : 'bg-gray-300'
                    }`}
                  >
                ...
                <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors cursor-pointer ${
                      preferences.marketing ? 'bg-[#111111]' : 'bg-gray-300'
                    }`}
                  >
                    <div className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${
                ...
                <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors cursor-pointer ${
                      preferences.functional ? 'bg-[#111111]' : 'bg-gray-300'
                    }`}
                  >
                    <div className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  className={`flex-1 px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap ${
                    acceptedTerms
                      ? 'bg-gray-900 hover:bg-[#111111] text-white cursor-pointer'
                      : 'bg-gray-300 text-gray-500 cursor-not-allowed'
                  }`}
                >
                  Accept All
