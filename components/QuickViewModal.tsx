                    ...
                    {images.map((image, index) => (
                      <button
                        ...
                        className={`relative aspect-square bg-gray-100 rounded-lg overflow-hidden border-2 transition-colors ${
                          selectedImage === index ? 'border-[#C8952A]' : 'border-transparent hover:border-gray-300'
                        }`}
                      >
              ...
              <div className="flex flex-col">
                <div className="mb-2">
                  <Link 
                    ...
                    className="text-sm text-[#C8952A] hover:text-[#a07020] font-medium whitespace-nowrap"
                  >
                    {product.category}
                  </Link>
                </div>
                ...
                <div className="flex items-baseline space-x-3 mb-4">
                  ...
                  {product.originalPrice && (
                    <>
                      ...
                      <span className="px-2 py-1 bg-[#fdf9ec] text-[#C8952A] text-sm font-semibold rounded whitespace-nowrap">
                  ...
                  <button
                    ...
                    className={`w-full py-4 rounded-lg font-semibold transition-colors whitespace-nowrap ${
                      addedToCart
                        ...
                        : product.inStock
                        ? 'bg-[#111111] hover:bg-[#111111] text-white'
