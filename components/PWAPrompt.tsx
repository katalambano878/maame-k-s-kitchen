          ...
          <div className="px-6 pb-8">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-bold text-gray-900 text-lg truncate">Maame Ks Kitchen</h3>
                <p className="text-sm text-gray-500">Maame Ks Kitchen — Cornerstone, Calgary, Alberta, Canada</p>
