...
export default function AdvancedSearch() {
  ...
  const allProducts: SearchSuggestion[] = [
    // Sample data — real menu items will appear here once added via the admin panel.
  ];
    ...
    <div ref={searchRef} className="relative flex-1 max-w-2xl mx-4">
      <div className="relative">
        <input
          ...
          className="w-full pl-12 pr-24 py-3 border-2 border-gray-300 rounded-full focus:border-[#C8952A] focus:ring-2 focus:ring-[#C8952A] text-sm"
        />
        ...
        <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center space-x-2">
          <button
            ...
            className={`w-8 h-8 flex items-center justify-center rounded-full transition-colors ${
              isVoiceActive ? 'bg-[#C8952A] text-white animate-pulse' : 'hover:bg-gray-100 text-gray-600'
            }`}
          >
            ...
            <div className="p-2">
              <div className="flex items-center justify-between px-3 py-2">
                ...
                <button
                  ...
                  className="text-xs text-[#C8952A] hover:text-[#7a5418] font-medium whitespace-nowrap"
                >
                  Clear All
                </button>
              </div>
