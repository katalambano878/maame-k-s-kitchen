...
export default function OrderBumpUpsell({ products, onToggle }: OrderBumpUpsellProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-emerald-50 to-[#0d0d0d] rounded-xl p-6 border-2 border-[#e8c87a]">
      <div className="flex items-center space-x-2 mb-4">
        <div className="w-10 h-10 flex items-center justify-center bg-[#C8952A] rounded-full">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-2">
                  <span className="text-lg font-bold text-[#C8952A]">${product.price.toFixed(2)}</span>
                  {product.originalPrice && (
                    <>
                      <span className="text-sm text-gray-400 line-through">${product.originalPrice.toFixed(2)}</span>
                      <span className="text-xs bg-[#fdf9ec] text-[#C8952A] px-2 py-1 rounded-full font-semibold whitespace-nowrap">
      ...
      <div className="mt-4 p-3 bg-[#fdf9ec] rounded-lg">
        <p className="text-sm text-[#a07020] font-medium text-center">
