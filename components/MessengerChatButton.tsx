  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 bg-gradient-to-br from-emerald-500 to-[#0d0d0d] text-white rounded-full shadow-2xl hover:scale-110 transition-transform z-50 flex items-center justify-center"
      >
        {isOpen ? (
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-96 h-[600px] bg-white rounded-2xl shadow-2xl z-50 flex flex-col overflow-hidden border border-gray-200">
          <div className="bg-gradient-to-r from-emerald-500 to-[#0d0d0d] text-white p-4">
            <div className="flex items-center gap-3">
              <div className="relative">
                <div className="w-12 h-12 flex items-center justify-center bg-white text-[#C8952A] rounded-full font-bold text-xl">
                  <i className="ri-customer-service-2-fill"></i>
                </div>
                <div className="absolute bottom-0 right-0 w-3 h-3 rounded-full bg-[#C8952A] border-2 border-white"></div>
              </div>
              <div className="flex-1">
                <h3 className="font-semibold">Customer Support</h3>
                <p className="text-sm text-emerald-100">Typically replies instantly</p>
              </div>
              <button
              ...
              >
                <div className={`max-w-[75%] ${msg.sender === 'user' ? 'order-2' : 'order-1'}`}>
                  <div className={`px-4 py-2 rounded-2xl ${
                    msg.sender === 'user'
                      ? 'bg-[#C8952A] text-white rounded-br-sm'
          ...
          <div className="border-t border-gray-200 p-3 bg-white">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="flex-1 px-4 py-2 bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-[#C8952A]"
              />
              <button
                onClick={handleSendMessage}
                className="w-9 h-9 flex items-center justify-center bg-[#C8952A] hover:bg-[#111111] text-white rounded-full transition-colors"
              >
