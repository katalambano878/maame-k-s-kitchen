    ...
    <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-2">
          ...
          {activeFilterCount > 0 && (
            <span className="bg-[#111111] text-white text-xs font-bold px-2 py-1 rounded-full">
              {activeFilterCount}
            </span>
          )}
        </div>
        <div className="flex items-center space-x-2">
          {activeFilterCount > 0 && (
            <button
              ...
              className="text-sm text-[#C8952A] hover:text-[#7a5418] font-medium whitespace-nowrap"
            >
              Clear All
            </button>
          )}
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <input
                  ...
                  className="w-full px-3 py-2 border-2 border-gray-300 rounded-lg text-sm focus:border-[#C8952A] focus:ring-2 focus:ring-[#C8952A]"
                  placeholder="Min"
                />
                      ...
                      {[...Array(5)].map((_, i) => (
                        <i
                          ...
                          className={`ri-star-${i < rating ? 'fill' : 'line'} text-sm ${
                            i < rating ? 'text-[#C8952A]' : 'text-gray-300'
                          }`}
                        ></i>
                      ))}
                    </div>
