...
export default function FlashSaleBanner() {
  ...
  return (
    <div className="bg-gradient-to-r from-[#111111] via-[#1a1a1a] to-[#0d0d0d] text-white py-3">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <a
              ...
              className="bg-white text-[#C8952A] px-6 py-2 rounded-lg font-bold hover:bg-gray-100 transition-colors whitespace-nowrap"
            >
              {flashSale.ctaText}
            </a>
          </div>
